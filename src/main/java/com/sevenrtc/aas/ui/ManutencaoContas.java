...
public class ManutencaoContas extends JDialog {
	 ...
	 * 
	 * @param args
	 *            argumentos passado como parametro
	 */
	 ...
	 *            janela Dona
	 * @param conta
	 *            Código da conta a ser manipulada
	 * @param childCount
	 *            quantidade de filhos da conta
	 * @param mOperacao
	 *            0 para inclusão e 1 para alteracao
	 */
	public ManutencaoContas(Dialog owner, String conta, int childCount,
			int mOperacao) {
		super(owner, true);
	...
	private void botaoConfirmar_actionPerformed() {
		...
		if (operacao == 0)// Inclusao
		{
			...
			if (contaAtual != null)
				// Conta pai e analitica. Logo, deve virar sintetica
	 ...
	 * 
	 * @param ultimaTeclaDigitada
	 *            conversão para string da ultima tecla digitada
	 */
	...
	/**
	 * Retorna o painel da janela atual.
	 * <p>
	 * A janela em questão possui campos para escolher o tipo da conta, nome e
	 * categoria DRE, além, é claro, de botoes para efetivar sua funcionalidade
	 * 
	...
	/**
	 * Inicializa a {@link javax.swing.JDialog} atual.
	 * <p>
	 * Para tanto, insere o painel principal na mesma, seta os handlers e
	 * executa o método pack
	 * 
	 * @throws Exception
	 *             caso seja impossivel criar o GUI
	 */
	private void jbInit() throws Exception {
		...
		if (operacao == 0)
			this.fieldConta.setText(conta + (childCount + 1));
